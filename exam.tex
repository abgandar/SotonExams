...
\ifluatex
    % A very simple vector class is provided as demonstrated in this piece of code.
    \begin{luacode*}
        mu = 1.327e11
        au = 1.496e8
    ...
    Also, for $\mu=\directlua{tex.print(mu)}$ the eccentricity vector is:
    $$\vec{e} = \frac{\vec{v}\times\vec{h}}{\mu}-\frac{\vec{r}}{r} = \directlua{e:print()}$$
\fi
% End of LuaTeX code
    \end{answer}
    }
